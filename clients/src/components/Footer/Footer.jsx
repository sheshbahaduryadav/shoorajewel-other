      ...
      <div className="mt-8 bg-violet-900 pt-9 footer text-white">
            ...
            <div className="md:w-[316px]">
              <div className="mt-[23px] flex">
                ...
                <div className="ml-[18px]">
                  <a href="tel:+911800123444" className="font-Inter text-[14px] font-medium ">+91 9998899989 | +91 9997779983</a>
              ...
              <div className="mt-[23px] flex">
                ...
                <div className="ml-[18px]">
                  <a href="mailto:rohitgold@hotmail.com" className="font-Inter text-[14px] font-medium">shoorajewel@gmail.com</a>
              ...
              <div className="mt-[23px] flex">
                ...
                <div className="ml-[18px]">
                  <a href="#" className="font-Inter text-[14px] font-medium">xyz sector 12,
                    India, 1332233</a>
        ...
        <div className="flex items-center sub-footer justify-center md:py-6">
          <p className="text-[10px] font-normal  md:text-[12px]">
            © Copyright
            {/* */}2024
            {/* */}, All Rights Reserved by Shoora Jewel.<Link>Pvt Ltd</Link>
          </p>
        </div>
      </div >
    </FooterWrapper>
